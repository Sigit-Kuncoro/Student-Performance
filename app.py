...
def load_model():
    try:
        model = joblib.load('/Student-Performance/model_gradulation.pkl')
        return model
    except FileNotFoundError:
        st.error("File model 'model_gradulation.pkl' tidak ditemukan. Pastikan model berada di direktori yang sama.")
        return None
